<template>
  <div class="common-style-table">
    <el-row class="search-bar" :gutter="20">
      ...
      <el-col :span="4">
        <el-input v-model="paramsForm.name" placeholder="运动类型名称" clearable />
      </el-col>
    ...
    >
      <template slot="action" slot-scope="{ index,record }">
        ...
        <el-button type="danger" size="mini" @click="$handleConfirm(record.id,'此操作将删除该类型，是否继续？')">删除</el-button>
      </template>
